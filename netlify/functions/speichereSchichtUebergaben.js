...
exports.handler = async function (event, context) {
    try {
        // Logge den gesamten Event und Kontext für Debugging-Zwecke
        console.log("Eingehende Anfrage:", event);
        console.log("Eingehender Kontext:", context);

        // Überprüfe, ob event.body vorhanden ist
        if (!event.body) {
            console.log("Leerer Body empfangen.");
            return {
                statusCode: 400,
