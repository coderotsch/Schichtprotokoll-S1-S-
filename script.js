...
function setzeEventListenerFuerMaschinen() {
 ...
 // Funktion zum Speichern von Übergeber, Übernehmer und Datum in der Datenbank
...
// Setze das aktuelle Datum beim Laden der Seite
document.addEventListener('DOMContentLoaded', () => {
    const today = new Date().toISOString().split('T')[0]; // Heutiges Datum im Format YYYY-MM-DD
    document.getElementById('date-display').value = today;
});
